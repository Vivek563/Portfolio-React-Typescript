...
function Project() {
  return (
    <>
    {/* <h2 >Updates are currently underway. <br/> We will provide a comprehensive update shortly.</h2> */}
    <section className="section blog bg-grey">
        ...
        <Card 
              title="Women Safety"
              projectdiscription="The Women Safety Android Application is a powerful and user-centric mobile app designed to provide women with a reliable and immediate safety solution. Built using Java and Firebase, this application addresses the critical issue of women's safety by incorporating an SOS feature."
              sourcelink="https://github.com/Vivek563/wsafety"
              livelink="https://github.com/Vivek563/wsafety"
        ...
        <div className="cardstyle">
          ...
          <Card 
              title="Blog Application Using Appwrite"
              projectdiscription="The Blog React App with Appwrite Database is a powerful and versatile web application that seamlessly combines the user-friendly interface of a React front-end with the robust capabilities of the Appwrite database to provide a comprehensive platform for creating, managing, and sharing blog content."
          ...
          <Card 
              ...
              projectdiscription="Welcome to my personal website, a dynamic online portfolio that showcases my skills, projects, and more. This website is built using a React-Typescript Vite application, providing a fast and efficient user experience.."
              sourcelink="https://github.com/Vivek563/Portfolio-React-Typescript"
              livelink="https://vivekmaurya.me"
              
          /> 
           <Card 
              title="All React Project"
              projectdiscription="This repository contains a collection of 10 React applications created while learning from the YouTube channel Chai and Code by Hitesh Choudary. Each application is built using Vite as the bundler and React as the JavaScript library."
              sourcelink="https://github.com/Vivek563/React.js-Practice-Projects"
              livelink="https://github.com/Vivek563/React.js-Practice-Projects"
              
          /> 
          
          <Card 
              title="Color Picker"
              projectdiscription="This is a project for creating a colorpicker tool. To use the colorpicker, simply move the cursor over the color card to select a color and click there it will automatically copy the color hex code to the clipboard."
              sourcelink="https://github.com/Vivek563/ColorPicker"
              livelink="https://osmcolor.netlify.app/"
     ...
     {/* <div style={{marginTop:"10rem",textAlign:"center"}} className="project-card-design">
